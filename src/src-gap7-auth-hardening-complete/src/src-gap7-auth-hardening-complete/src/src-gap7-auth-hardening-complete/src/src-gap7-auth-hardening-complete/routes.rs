...
use crate::{auth, extractor, google_oauth, identity, llm::{ChatMessage, LlmProvider}, memory, semantic_search, tools, tool_registry, AppState};
...
pub fn api_router() -> Router<AppState> {
    Router::new()
        ...
        .merge(google_oauth::google_router())
}
